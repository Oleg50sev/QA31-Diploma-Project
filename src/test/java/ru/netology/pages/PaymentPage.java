...
public class PaymentPage {
    ...
    public void waitIfWrongFormatMessage() {
        wrongFormatMessage.shouldBe(Condition.visible, Duration.ofSeconds(10));
    }

    public void waitIfWrongTermMessage() {
        wrongTermMessage.shouldBe(Condition.visible, Duration.ofSeconds(10));
    }

    public void waitIfCardExpiredMessage() {
        cardExpiredMessage.shouldBe(Condition.visible, Duration.ofSeconds(10));
    }

    public void waitIfShouldFillFieldMessage() {
        fieldFillRequiredMessage.shouldBe(Condition.visible, Duration.ofSeconds(10));
    }
}
